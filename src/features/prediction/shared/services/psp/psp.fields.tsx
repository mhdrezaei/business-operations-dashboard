...
export function YearlyValueIncomePredictionFields({ operationTitleKey }: YearlyValueIncomeFieldsProps) {
	const { t } = useTranslation();
...
export function PspPredictionFields() {
	return <YearlyValueIncomePredictionFields operationTitleKey="prediction.operations.psp" />;
}
