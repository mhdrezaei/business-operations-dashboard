...
export default function TemplateCreateHeader({ onClose, onOpenPrintPreview, onExportWord }: ExtendedHeaderProps) {
				...
				<Popconfirm
					...
					onConfirm={() => {
						if (onExportWord) {
							...
							message.error("خطا: تابع دانلود به هدر متصل نشده است!");
						}
					}}
					...
					// 🔴 این دو خط مشکل ناپدید شدن پاپ‌آپ را کاملاً حل می‌کنند:

					zIndex={100000} // آوردن پاپ‌آپ به بالاترین لایه ممکن (روی تمام مودال‌ها)

					getPopupContainer={triggerNode => triggerNode.parentNode as HTMLElement} // رندر کردن پاپ‌آپ در خود هدر به جای body
